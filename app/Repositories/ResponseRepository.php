...
class ResponseRepository {
    public function get( ResponseReadDTO $dto ) {
        ...
        $select_columns = ['response.id', 'response.form_id', 'form.title as form_title', 'response.is_read', 'response.is_starred', 'response.device', 'response.browser', 'response.created_at', 'response.updated_at'];
