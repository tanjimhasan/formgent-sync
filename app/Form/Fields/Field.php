...
namespace FormGent\App\Form\Fields;
...
abstract class Field {
    ...
    public function get_field_dto( array $field, WP_REST_Request $wp_rest_request, stdClass $form ): AnswerDTO {
        $dto = new AnswerDTO();
        return $dto->set_form_id( $form->ID )->set_field_type( $field['field_type'] )->set_field_id( $field['id'] )->set_value( $wp_rest_request->get_param( $field['name'] ) );
    }
