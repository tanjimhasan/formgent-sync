/******/ ( () => {
  ...
  \***************************************/
			/***/ (
				...
				/* harmony import */ var _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_4___default =
					/*#__PURE__*/ __webpack_require__.n(
				...
				/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_5___default =
					/*#__PURE__*/ __webpack_require__.n(
						_wordpress_element__WEBPACK_IMPORTED_MODULE_5__
					);
				/* harmony import */ var _wordpress_server_side_render__WEBPACK_IMPORTED_MODULE_6__ =
					__webpack_require__(
						/*! @wordpress/server-side-render */ '@wordpress/server-side-render'
					);
				/* harmony import */ var _wordpress_server_side_render__WEBPACK_IMPORTED_MODULE_6___default =
					/*#__PURE__*/ __webpack_require__.n(
						_wordpress_server_side_render__WEBPACK_IMPORTED_MODULE_6__
					);
				/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_7__ =
					__webpack_require__(
						/*! ./editor.scss */ './resources/blocks/form/editor.scss'
					);
				...
				const Form = ( { formId } ) => {
					...
					react__WEBPACK_IMPORTED_MODULE_0__.createElement )(
						_wordpress_server_side_render__WEBPACK_IMPORTED_MODULE_6___default(),
						{
							block: 'formgent/form',
							attributes: {
								formId,
				...
				function Edit( { attributes, setAttributes } ) {
					...
					_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useState )(
						[]
					);
					...
					( 0,
					_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useEffect )( () => {
  ...
  \****************************************/
			/***/ (
				...
				/* harmony import */ var _Edit__WEBPACK_IMPORTED_MODULE_2__ =
					__webpack_require__(
						/*! ./Edit */ './resources/blocks/form/Edit.js'
					);
				/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ =
					__webpack_require__(
						/*! ./block.json */ './resources/blocks/form/block.json'
					);
				/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ =
					__webpack_require__(
						/*! ./style.scss */ './resources/blocks/form/style.scss'
					);
				/**
		...
		/***/ './resources/blocks/form/editor.scss':
			/*!*******************************************!*\
  !*** ./resources/blocks/form/editor.scss ***!
  \*******************************************/
			/***/ (
		...
		/***/ './resources/blocks/form/style.scss':
			/*!******************************************!*\
  !*** ./resources/blocks/form/style.scss ***!
  \******************************************/
			/***/ (
  ...
  \******************************************/
		...
		/***/ './resources/blocks/form/block.json':
			/*!******************************************!*\
  !*** ./resources/blocks/form/block.json ***!
  \******************************************/
			/***/ ( module ) => {
				module.exports = /*#__PURE__*/ JSON.parse(
					'{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"formgent/form","title":"Form","category":"formgent","description":"FormGent Form","textdomain":"formgent","attributes":{"formId":{"type":"number","default":0}},"supports":{"color":{"text":false,"background":true},"spacing":{"margin":true,"padding":true},"__experimentalBorder":{"color":true,"radius":true,"width":true,"__experimentalDefaultControls":{"radius":true}},"interactivity":true},"editorScript":"file:index.js","style":"file:style-index.css","editorStyle":"file:index.css","render":"file:render.php"}'
				);
	...
	/******/ var __webpack_exports__ = __webpack_require__.O(
		undefined,
		[ 'form/style-index' ],
		() => __webpack_require__( './resources/blocks/form/index.js' )
	);
