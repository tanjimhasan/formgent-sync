...
! ( function ( e, i ) {
	...
	var r = ( ( e ) => (
		...
		a = ( ( e ) => (
			( e.Label = 'label' ), ( e.LabelArrow = 'labelArrow' ), e
		) )( a || {} );
	const n = [
	...
	return class {
			...
			__publicField( this, 'form', null ),
				...
				__publicField( this, 'handleGroupChange', ( e ) => {
					...
					for ( const t in this.groupFields ) {
						if (
							this.groupFields[ t ].elems.find( ( i ) => i === e )
						) {
							i = t;
							break;
						}
		...
		isFormValid() {
			let e = ! 0;
			for (
				let i = 0, t = Object.values( this.fields ).length;
				i < t;
				++i
			) {
		...
		revalidateGroup( e ) {
			...
			return i && this.groupFields[ i ]
				...
				: ( console.error(
						'Group not found. Check the group selector.'
				  ),
				  Promise.reject() );
		}
		validateGroup( e, i = ! 1 ) {
		...
		addField( e, i, t ) {
			...
			if (
				( ( s =
					'string' == typeof e ? this.form.querySelector( e ) : e ),
				! s )
			)
				throw Error(
