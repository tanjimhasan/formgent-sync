...
export const SingleFormActions = {
	...
	fetchAnalyticsSubmission: ( path ) => {
		return {
			type: 'FETCH_ANALYTICS_SUBMISSION',
			path,
		};
	},
	fetchAnalyticsSubmissionRequest: () => {
		return {
			type: 'FETCH_ANALYTICS_SUBMISSION_REQUEST',
		};
	},
	fetchAnalyticsSubmissionSuccess: ( data, formId ) => {
		return {
			type: 'FETCH_ANALYTICS_SUBMISSION_SUCCESS',
			payload: {
				data,
				formId,
			},
	...
	fetchAnalyticsSubmissionError: ( error ) => {
		return {
			type: 'FETCH_ANALYTICS_SUBMISSION_ERROR',
			error,
		};
	},

	fetchQuestionDropOff: ( path ) => {
		return {
			type: 'FETCH_QUESTION_DROP_OFF',
			path,
		};
	},
	fetchQuestionDropOffRequest: () => {
		return {
			type: 'FETCH_QUESTION_DROP_OFF_REQUEST',
		};
	},
	fetchQuestionDropOffSuccess: ( data, formId ) => {
		return {
			type: 'FETCH_QUESTION_DROP_OFF_SUCCESS',
			payload: {
				data,
				formId,
			},
	...
	fetchQuestionDropOffError: ( error ) => {
		return {
			type: 'FETCH_QUESTION_DROP_OFF_ERROR',
			error,
		};
	},
};
